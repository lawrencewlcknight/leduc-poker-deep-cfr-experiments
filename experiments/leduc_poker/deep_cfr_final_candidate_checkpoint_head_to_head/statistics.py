"""Seed-level inference for exact checkpoint head-to-head values."""
...
def _holm_adjust(p_values: Sequence[float]) -> List[float]:
    """Holm-adjusts a family of p-values while preserving input order."""
...
def build_inference_tables(
    ...
    """Builds seed effects, headline summaries, and pairwise inference rows.

    The primary observation is one mean later-vs-earlier EV per independent
    training seed. Pairwise checkpoint tests are secondary and Holm-adjusted.
    """
