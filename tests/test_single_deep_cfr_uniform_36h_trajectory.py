"""Contract and end-to-end smoke coverage for Experiment 29."""
...
from experiments.leduc_poker.single_deep_cfr_uniform_36h_trajectory.cloud import (
    aggregate_workers,
...
from experiments.leduc_poker.single_deep_cfr_uniform_36h_trajectory.run import (
    read_csv,
    read_json,
)


def test_experiment_29_preserves_the_selected_experiment_28_advantage_learner():
    for field in (
        "num_traversals",
        ...
        assert TRAINING_CONFIG[field] == EXPERIMENT_28_CONFIG[field], field
...
@pytest.mark.smoke
def test_experiment_29_end_to_end_smoke(tmp_path):
